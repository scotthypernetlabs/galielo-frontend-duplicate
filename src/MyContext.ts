...
export class MyContext {
    ...
    initialize(settings: ISettingsRepository,
        ...
        this.jobService = new JobService(this.jobRepository, this.logger);
        if (token) {
          ...
          this.galileoAPI = new GalileoApi(apiSocket, this.offerService, this.stationService, this.machineService, this.jobService, this.logger);
